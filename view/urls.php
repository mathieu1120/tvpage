...
echo '<div class="row"><div class="col-sm-8"><ul class="list-group">';
...
echo '</ul></div>';
echo '<div class="canvas-div col-sm-4 pull-right">Domain name Presence:<canvas class="canvas"></canvas></div></div>';
